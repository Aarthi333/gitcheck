...
namespace day27_Client.Models
{
    public class OrderDetails
    {
        ...
        public string Crust_1 { get; set; }
        public string Crust_2 { get; set; }
        public string Crust_3 { get; set; }
        public string Suggestions_1 { get; set; }
        public string Suggestions_2 { get; set; }
        public string Suggestions_3 { get; set; }
